...
# Zod Types Provider
- is a module aimed at validation and backend typing using TypeScript. It applies validations with Zod, works with conditional data and mapped types, promoting greater security, consistency and predictability in the structure of application data.

# Designer
- The Designer is an agent focused on creating responsive interfaces for mobile, tablet and desktop, following conventional commit messaging standards. It integrates practices with Git and TailwindCSS, facilitating the automation of commits through the /commit command, ensuring organization and standardization in the development flow